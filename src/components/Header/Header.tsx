...
import logoSmallImg from "../../assets/LOGO.png";
        ...
        <div className="App-header large">
          <div className="App-header-container-left">
            {/* <Link className="App-header-link-main" to="/">
              <img src={logoImg} className="big" alt="OLYEX Logo" />
              <img src={logoSmallImg} className="small" alt="OLYEX Logo" />
            </Link> */}
            <a className="App-header-link-main" href="https://www.olyex.finance/" target="_blank">
              <img src={logoImg} className="big" alt="OLYEX Logo" />
              <img src={logoSmallImg} className="small" alt="OLYEX Logo" />
            </a>
            {isHomeSite() ? (
